def load_files():
    with open('python/labelled_data/labelled_bedrooms_data_sample.txt.txt') as f:
        bedrooms_lines = f.readlines()
    with open('python/labelled_data/labelled_living_rooms_data_sample.txt.txt') as f:
        living_rooms_lines = f.readlines()
    with open('python/labelled_data/labelled_kitchens_data_sample.txt.txt') as f:
        kitchens_lines = f.readlines()
    with open('python/labelled_data/labelled_dining_data_sample.txt.txt') as f:
        dining_lines = f.readlines()
    with open('python/labelled_data/labelled_bathrooms_data_sample.txt.txt') as f:
